...
import com.zhy.zlib.listener.OnInitSelectedPosition;
import com.zhy.zlib.listener.OnTagClickListener;
import com.zhy.zlib.listener.OnTagSelectListener;
...
/**
 * Created by zhouyang on 2018/9/10.
 */
public class FlowTagLayout extends ViewGroup {
    ...
    public void saveData(int j, View childView) {
        if (mCheckedTagArray.get(j)) {
            mCheckedTagArray.put(j, false);
            childView.setSelected(false);
        } else {
